...
var ok = 0;
var total = 0;
function check(name2, cond) {
  total++;
  if (cond) ok++;
  else process.stderr.write("  FAIL " + name2 + "\n");
}
var red = chalk.red("error");
check("red", red.includes("error"));
var green = chalk.green("success");
check("green", green.includes("success"));
var blue = chalk.blue("info");
check("blue", blue.includes("info"));
var bold = chalk.bold("strong");
check("bold", bold.includes("strong"));
var underline = chalk.underline("link");
check("underline", underline.includes("link"));
var chained = chalk.red.bold.underline("important");
check("chained", chained.includes("important"));
var bg = chalk.bgRed("alert");
check("bgRed", bg.includes("alert"));
var composed = chalk.red("a") + " " + chalk.green("b");
check("compose-contains", composed.includes("a") && composed.includes("b"));
var nested = chalk.red("red " + chalk.bold("bold") + " red");
check("nested", nested.includes("bold"));
var name = "NanoVM";
var msg = chalk.blue(`Hello ${name}!`);
