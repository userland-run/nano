...
var require_marked = __commonJS({
  "node_modules/marked/lib/marked.cjs"(exports2) {
    ...
    function outputLink(cap, link2, raw, lexer2) {
      var href = link2.href;
      var title = link2.title ? escape(link2.title) : null;
    ...
    var Tokenizer = /* @__PURE__ */ function() {
      ...
      _proto.table = function table2(src) {
    ...
    var Renderer = /* @__PURE__ */ function() {
      ...
      _proto.table = function table2(header, body) {
    ...
    var Hooks = /* @__PURE__ */ function() {
      ...
      _proto.postprocess = function postprocess(html2) {
        return html2;
      };
      return Hooks2;
    }();
      ...
      return function(src, opt, callback) {
        ...
        if (opt.async) {
          return Promise.resolve(opt.hooks ? opt.hooks.preprocess(src) : src).then(function(src2) {
            ...
            return opt.hooks ? opt.hooks.postprocess(html3) : html3;
          })["catch"](throwError);
        }
        try {
          if (opt.hooks) {
...
var bold = marked("**bold**").trim();
check("bold", bold.includes("<strong>bold</strong>"));
var italic = marked("*italic*").trim();
check("italic", italic.includes("<em>italic</em>"));
var link = marked("[Google](https://google.com)").trim();
